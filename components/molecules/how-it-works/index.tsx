...
const HowItWorks = () => {
    ...
    return (
        <div className="mt-20">
            <div className="text-2xl lg:text-3xl xl:text-5xl font-bold text-center md:mb-10">How it works</div>
                ...
                <div className="flex flex-col lg:flex-row items-center justify-around lg:justify-between">
                    {
                        steps.map((step, index) => (
                            <div key={index} className="flex flex-col  items-center relative">
                                ...
                                <p className="text-xs sm:text-sm text-center font-normal">{step.description}</p>
